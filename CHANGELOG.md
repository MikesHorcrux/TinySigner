...
- Built the local-first TinySigner PDF editor experience.
- Added PDFKit preview, page thumbnails, signing/form tools, drag/resize/delete, undo/redo, zoom, and flattened export.
- Added signer profile, signature assets, recent document storage, sandbox file access, and export tests.
- Fixed live signature dragging by moving preview rendering out of PDF annotations into an overlay view.
